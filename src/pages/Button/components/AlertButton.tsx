...
const alertButtonVariants = cva('relative   rounded-md text-sm font-medium ', {
  variants: {
    variant: {
    ...
    alertStyle: {
      none: '',
      pulse:
        'before:absolute before:inset-0 before:rounded-[inherit] before:animate-pulse before:bg-current before:opacity-25',

...
const audioPlayButtonVariants = cva(
...
interface AudioPlayButtonProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement>,
    VariantProps<typeof audioPlayButtonVariants> {
  src: string;
  autoPlay?: boolean;
...
const AudioPlayButton = React.forwardRef<HTMLButtonElement, AudioPlayButtonProps>(
  (
    {
      className,
      variant,
    ...
    const handleTimeUpdate = () => {
      if (audioRef.current) {
        ...
        onTimeUpdate?.(audioRef.current.currentTime, duration);
      }
    };
    ...
    return (
      <div className="inline-flex flex-col gap-2">
        ...
        <button
          ref={ref}
          type="button"
          className={cn(audioPlayButtonVariants({ variant, size }), className)}
          onClick={togglePlay}
          {...props}
        >
          {isPlaying ? (

...
// Calendar Component
const calendarVariants = cva('p-3 space-y-4 bg-background rounded-lg shadow-sm ', {
  variants: {
    variant: {
      default: '',
  ...
  (
    ...
    const handleDateSelect = (day: number) => {
      ...
      if (
        ...
        disabledDates.some((disabledDate) => disabledDate.toDateString() === newDate.toDateString())
      ) {
        return;
      }
    ...
    return (
      ...
      >
        <div className="flex rounded-xl items-center justify-between mb-4">
          <button onClick={() => { handleMonthChange(-1); }} className="p-1 hover:bg-accent rounded-sm">
            ←
          </button>

  ...
  'flex items-stretch w-full border border-gray-200 rounded-lg overflow-hidden',
  {
    variants: {
      variant: {
        ...
        ghost:
          '[&_input]:bg-transparent [&_input]:border-b-0 [&_button]:bg-transparent [&_button]:border-b-0',
      },
      size: {
    ...
    return (
      <InputGroupContext.Provider value={{ variant, size, disabled }}>
        <div
          ref={ref}
          className={cn(
            inputGroupVariants({ variant, size } as {
    ...
    return (
      <button
        ...
        className={cn(
          ...
          (disabled || context.disabled) && 'opacity-50 cursor-not-allowed pointer-events-none',
          className
        )}
      ...
      <div className="flex-1 min-w-0">
        <input
          ...
          className={cn(
            ...
            (disabled || context.disabled) && 'opacity-50 cursor-not-allowed',
            className
          )}
          disabled={disabled || context.disabled}
          {...props}
...
export { InputGroup, InputGroupText, InputGroupButton, InputGroupInput };

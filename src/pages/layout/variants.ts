...
export const navbarVariants = cva('w-full flex items-center transition-all duration-300', {
  variants: {
    variant: {
...
export const navLinkVariants = cva('relative flex items-center transition-colors duration-200', {
  variants: {
    variant: {
